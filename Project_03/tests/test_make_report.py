...
from SimpleReport import SimpleReport as sr
...
class UiAutoTestCase(unittest.TestCase):
    ...
    @sr.add_test_img('点击第一个文章页面前', '点击第一个文章页面后')
    ...
    @sr.add_test_img('test_errors_save_imgs')
    ...
    @sr.add_test_img('test_success_case_img')
