...
from Project_02_Improve.HttpServer.views.account import account as account_blueprint
from Project_02_Improve.HttpServer.views.home import home as home_blueprint
